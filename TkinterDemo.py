...
insert=Button(root,text="INSERT",font=("Arial",12),bg="black",fg="white",command=insert_data)
insert.place(x=50,y=300)

search=Button(root,text="SEARCH",font=("Arial",12),bg="black",fg="white",command=search_data)
search.place(x=121,y=300)

update=Button(root,text="UPDATE",font=("Arial",12),bg="black",fg="white",command=update_data)
update.place(x=203,y=300)

delete=Button(root,text="DELETE",font=("Arial",12),bg="black",fg="white",command=delete_data)
delete.place(x=283,y=300)
